...
from stable_baselines3.common.policies import BasePolicy, register_policy, create_sde_features_extractor, BaseModel
...
class TQCPolicy(BasePolicy):
    ...
    def __init__(self, observation_space: gym.spaces.Space,
                 ...
                 n_quantiles: int = 25,
                 n_critics: int = 2):
        super(TQCPolicy, self).__init__(observation_space, action_space,
                                        device,
