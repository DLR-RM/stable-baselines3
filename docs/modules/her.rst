...
.. warning::
    ...
    HER requires the environment to follow the legacy `gym.GoalEnv <https://github.com/openai/gym/blob/3394e245727c1ae6851b504a50ba77c73cd4c65b/gym/core.py#L160>`_
    In short, the `gym.Env` must have:
    - a vectorized implementation of ``compute_reward()``
    - a dictionary observation space with at least three keys: ``observation``, ``achieved_goal`` and ``desired_goal``
