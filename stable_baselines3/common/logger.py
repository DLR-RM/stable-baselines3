...
class FormatUnsupportedError(NotImplementedError):
    def __init__(self, *unsupported_formats: str):
        ...
        super(FormatUnsupportedError, self).__init__(
            f"The {format_str} not supported for the value type logged.\n"
    ...
    def write(self, key_values: Dict, key_excluded: Dict, step: int = 0) -> None:
        ...
        for (key, value), (_, excluded) in zip(sorted(key_values.items()), sorted(key_excluded.items())):
            ...
            if isinstance(value, Video):
                raise FormatUnsupportedError("stdout", "log")
...
class JSONOutputFormat(KVWriter):
    ...
    def write(self, key_values: Dict[str, Any], key_excluded: Dict[str, Union[str, Tuple[str, ...]]], step: int = 0) -> None:
        def cast_to_json_serializable(value: Any):
            if isinstance(value, Video):
                raise FormatUnsupportedError("json")
