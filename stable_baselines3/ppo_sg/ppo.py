...
SelfPPOSG = TypeVar("SelfPPOSG", bound="PPOSG")


class PPOSG(OnPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        self.surrogate_env = surrogate_env
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                actions, _, log_probs = self.policy(state, deterministic=False)
                
                state, total_reward = self.surrogate_env.step(state, actions)
                ...
                for i in range(horizon):
                    ...
                    actions, _, log_probs = self.policy(state, deterministic=True)
                    
                    # Step in the surrogate environment
                    state, reward = self.surrogate_env.step(state, actions)
        ...
        # Logs
        self.logger.record("train/loss", total_reward.item())
