...
and multiprocessing for you. To install the Atari environments, run the command``pip install gym[atari, accept-rom-license]`` to install the Atari environments and ROMs.
...
.. code-block:: python
  ...
  env = make_atari_env('PongNoFrameskip-v5', n_envs=4, seed=0)
