...
.. note::
  ...
  However, if the vectorized environment is directly initialized (e.g. gym3-style environments), then it is possible such environment does not provide the ``terminal_observation``.
